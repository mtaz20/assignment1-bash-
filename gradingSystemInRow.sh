...
tot=$(expr $m1 + $m2 + $m3 + $m4 + $m5) 
 ...
 if [ $tot -ge 91 ] 
 then 
echo "$name   $rno   $gen    $m1        $m2      $m3      $m4      $m5       $tot      A">>Grades.csv 
...
echo "$name   $rno   $gen    $m1        $m2      $m3      $m4      $m5       $tot      A-">>Grades.csv 
 ...
 then 
echo "$name   $rno   $gen    $m1        $m2      $m3      $m4      $m5       $tot      B">>Grades.csv 
...
echo "$name   $rno   $gen    $m1        $m2      $m3      $m4      $m5       $tot   B-">>Grades.csv 
 ...
 then 
echo "$name   $rno   $gen    $m1        $m2      $m3      $m4      $m5       $tot   C">>Grades.csv 
...
echo "$name   $rno   $gen    $m1        $m2      $m3      $m4      $m5       $tot   C-">>Grades.csv 
 ...
 then 
echo "$name   $rno   $gen    $m1        $m2      $m3      $m4      $m5       $tot   D">>Grades.csv 

 elif [ $tot -le 60 ] 
 then 
echo "$name   $rno   $gen    $m1        $m2      $m3      $m4      $m5       $tot   F">>Grades.csv 
